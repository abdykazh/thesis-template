...
\documentclass[twoside,en]{./zyx/mythesis}
...
\subfile{./txt/0-introduction.tex}

\subfile{./txt/1-literature-review.tex}

\subfile{./txt/2-background.tex}

\subfile{./txt/3-methodology.tex}

\subfile{./txt/4-results.tex}

\subfile{./txt/5-discussion.tex}

\subfile{./txt/6-conclusion.tex}
